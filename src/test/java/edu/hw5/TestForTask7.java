...
public class TestForTask7 {
    ...
    void test(String input, boolean expected) {
        ...
        boolean actual = Task7.containsAtLeastThreeSymbolsAndTheThirdIsZero(input);
    ...
    void test2(String input, boolean expected) {
        ...
        boolean actual = Task7.startsWithAndEndsWithTheSameSymbol(input);
    ...
    void test3(String input, boolean expected) {
        ...
        boolean actual = Task7.lengthBetweenOneAndThree(input);
